...
protected:
	...
	afx_msg void OnBnClickedCheckBdVideo();
	afx_msg void OnBnClickedCheckCloseDisc();
...
protected:
	...
	CButton		m_chkCloseTrack;
	CButton		m_chkCloseSession;
	...
	CComboBox	m_comboFormatSubType;
